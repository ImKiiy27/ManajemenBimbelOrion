<?php
// ============================================================
// controllers/wali_murid/profil/WaliMuridProfilActionHandler.php
// Handler aksi profil wali murid
// ============================================================

class WaliMuridProfilActionHandler
{
  ...
  public function handle(string $userId): void
  {
    if (!verifyCsrfToken($_POST['_csrf'] ?? null)) {
      ...
      header('Location: index.php?page=wali-profil');
      exit;
    }
    ...
    if ($action === 'update-profile') {
      $result = $this->profileRepository->updateProfile($userId, 'wali_murid', $_POST);
